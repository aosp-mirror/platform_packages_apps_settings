...
public class axiomVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "axiomVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_AXIOM_VERSION_PROP = "ro.axiom.display.version";
    ...
    public axiomVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    String axiomVer = SystemProperties.get(KEY_AXIOM_VERSION_PROP);
    if (!axiomVer.isEmpty())
        return axiomVer;
    else
